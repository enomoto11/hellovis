...
const (
	// Label holds the string label denoting the studentcheckout type in the database.
	Label = "student_checkout"
	...
	Table = "student_checkouts"
	// StudentTable is the table that holds the student relation/edge.
	StudentTable = "student_checkouts"
...
// Columns holds all SQL columns for studentcheckout fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the StudentCheckout queries.
